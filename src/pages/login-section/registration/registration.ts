    ...
    //     }
        ...
        submit()
        {
            ...
            .subscribe( (result) =>
            {
                ...
                this.dsr_match = result['status']
               if(result['status'] == "NOTEXIST")
                {
                    this.translate.get("DSR Code not Exixt")
                    .subscribe(resp=>{
                        this.showAlert(resp);
                    })
                    return;
                }
                if(this.dsr_match == "Exist" || this.dsr_match == 'NODSRCODE' ){
            ...
            //  console.log(this.data);
                   ...
                   if (this.data.first_name =='' ) {
                    ...
                    this.alertToast("Please fill First Name")
                    return
                }
                ...
                // }
                    ...
                    // alert('Please fill the Blank input');
                    this.alertToast("Please fill State")
                    return
                }
                else if (this.data.district =='' ) {
                    // alert('Please fill the Blank input');
                    this.alertToast("Please fill District")
                    return
                }
                    ...
                    // alert('Please fill the Blank input');
                    this.alertToast("Please fill City")
                    return
                }
