...
import { PdfCataloguePageModule } from '../pages/pdf-catalogue/pdf-catalogue.module';
import { DocumentViewer } from '@ionic-native/document-viewer';
import { ProductSubCategoryPageModule } from '../pages/product-sub-category/product-sub-category.module';
import { SocialpagePage } from '../pages/socialpage/socialpage';
import { SocialpagePageModule } from '../pages/socialpage/socialpage.module';
import { DealerAddPageModule } from '../pages/sale-user-dealer/dealer-add/dealer-add.module';
import { DealerListPageModule } from '../pages/sale-user-dealer/dealer-list/dealer-list.module';
import { MechanicListPageModule } from '../pages/sale-user-mechanic/mechanic-list/mechanic-list.module';
